...
import { mdiAdjust, mdiPalette, mdiPen, mdiEraserVariant, mdiFormatColorFill, mdiDelete } from '@mdi/js';
...
const Size = props => {
  ...
  }, [4, 6, 8, 10, 15].map(size => /*#__PURE__*/React.createElement(Circle, {
    key: size,
    size: size,
    property: size,
    color: props.color,
...
const Color = props => {
  ...
  }, colors.map(color => /*#__PURE__*/React.createElement(Circle, {
    key: color,
    size: 30,
    color: color,
    property: color,
...
const Menu = props => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "Erase",
    label: mdiEraserVariant
  }, prop)), /*#__PURE__*/React.createElement(Size, _extends({}, prop, {
    color: color,
    dispatchData: props.dispatchData
  })), /*#__PURE__*/React.createElement(Color, _extends({}, prop, {
    color: color,
    setColor: colorChange
  })), /*#__PURE__*/React.createElement(IconButton, _extends({
    name: "Flood Fill",
    label: mdiFormatColorFill
  }, prop, {
    color: color
  })), /*#__PURE__*/React.createElement(IconButton, _extends({
    name: "Clear Frame",
...
const CanvasSketchTool = props => {
  ...
  }), /*#__PURE__*/React.createElement(CanvasSketch, _extends({}, props, properties, {
    lineCap: "round",
    getClearCanvas: setClearCanvas
  })));
};

export { CanvasSketch, CanvasSketchTool };
